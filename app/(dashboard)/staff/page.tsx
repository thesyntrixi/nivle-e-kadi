  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-h1 text-neutral-text">Check-In Staff Management</h2>
      ...
      {showForm && (
        <Card padding="lg" className="space-y-4 border border-primary/30">
          <h3 className="text-h2 text-neutral-text">
      ...
      {loading ? (
        ...
        <div className="space-y-4">
          <h3 className="text-small font-semibold uppercase tracking-wide text-neutral-muted">
            Staff List
          </h3>
          {staffList.map((staff) => (
